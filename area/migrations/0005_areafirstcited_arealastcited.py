    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sources', models.ManyToManyField(related_name='area_areafirstcited_related', to='source.Source')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', django_date_extensions.fields.ApproximateDateField(blank=True, default=None, null=True)),
                ('object_ref', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='area.Area')),
                ('sources', models.ManyToManyField(related_name='area_arealastcited_related', to='source.Source')),
            ],
            options={
                'abstract': False,
            },
