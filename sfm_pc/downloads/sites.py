...
class SiteDownload(BaseDownload):
    # Class metadata
    download_type = 'sites'
    ...
    def _get_field_map(cls):
        ...
        return OrderedDict([
            ...
            ('site_id_confidence', {
                ...
                'label': 'unit:site_exact_location:confidence',
                'confidence': True,
                'serializer': cls.serializers['identity'],
            }),
            ('site_name', {
                'sql': 'location.name',
                'label': 'unit:site_exact_location_name_longitude',
                'serializer': cls.serializers['identity'],
            }),
            ('site_division_id', {
                'sql': 'location.division_id',
                'label': 'unit:site_country',
                'serializer': cls.serializers['division_id'],
            }),
            ('site_feature_type', {
                'sql': 'location.feature_type',
                'sql': 'location.feature_type',
                'label': 'unit:site_feature_type',
                'serializer': cls.serializers['identity'],
            }),
            ('site_admin_level', {
                'sql': 'location.admin_level',
                'label': 'unit:site_admin_level',
                'serializer': cls.serializers['identity'],
            }),
            ('site_admin_level_1_id', {
                'sql': 'location.admin_level_1_id',
                'label': 'unit:site_nearest_settlement_id',
                'serializer': cls.serializers['identity'],
            }),
            ('site_admin_level_1_name', {
                'sql': 'location.admin_level_1_name',
                'label': 'unit:site_nearest_settlement_name',
                'serializer': cls.serializers['identity'],
            }),
            ('site_admin_level_2_id', {
                'sql': 'location.admin_level_2_id',
                'label': 'unit:site_first_admin_area_id',
                'serializer': cls.serializers['identity'],
            }),
            ('site_admin_level_2_name', {
                'sql': 'location.admin_level_2_name',
                'label': 'unit:site_first_admin_area_name',
                'serializer': cls.serializers['identity'],
            }),
        ])
